...
export default function LoginPage() {
  ...
  async function handleLogin(e) {
    ...
    // Diferencia clave con el registro: aquí NO creamos usuario, lo
    // AUTENTICAMOS. Por eso el método es signInWithPassword.
    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      ...
      >
        ...
        {/* Botón de Google. type="button" es imprescindible: evita que,
            al estar dentro del <form>, dispare el submit de email/contraseña. */}
        <button
          type="button"
        ...
        <p className="text-center text-sm text-slate-400">
          ¿No tienes cuenta?{" "}
          <a href="/registro" className="text-cyan-400 hover:underline">
            Regístrate
          </a>
        </p>
      </form>
